...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__variants_v_published_locale" AS ENUM('fr');
  ...
  CREATE TYPE "public"."enum__products_v_published_locale" AS ENUM('fr');
  ...
  CREATE TABLE "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_logo_image_id" integer,
  	"logo_logo_text" varchar DEFAULT 'ATELIER CINQUINI',
  	"logo_logo_subtext" varchar DEFAULT 'CRÉATIONS TEXTILES',
  ...
  ALTER TABLE "header" ADD CONSTRAINT "header_logo_logo_image_id_media_id_fk" FOREIGN KEY ("logo_logo_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "header_logo_logo_logo_image_idx" ON "header" USING btree ("logo_logo_image_id");
